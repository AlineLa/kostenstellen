...
public class ReiseKostenProxi extends KonkreteKostenArtProxi implements PersistentReiseKosten{
    
    public ReiseKostenProxi(long objectId) {
        super(objectId);
    }
    public ReiseKostenProxi(PersistentInCacheProxi object) {
        super(object);
    }
