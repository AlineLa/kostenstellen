...
public class FindeKontoCommandICProxi extends PersistentInCacheProxi implements PersistentFindeKontoCommand{
    
    public FindeKontoCommandICProxi(long objectId) {
        super(objectId);
    }
    public FindeKontoCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theFindeKontoCommandFacade
            .getFindeKontoCommand(this.getId());
    }
