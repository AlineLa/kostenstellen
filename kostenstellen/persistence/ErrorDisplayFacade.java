...
public class ErrorDisplayFacade{
    ...
    public PersistentErrorDisplay newErrorDisplay(long createMinusStorePlus) throws PersistenceException {
        if(createMinusStorePlus > 0) return (PersistentErrorDisplay)PersistentProxi.createProxi(createMinusStorePlus, -101);
        ...
        return (PersistentErrorDisplay)PersistentProxi.createProxi(id, -101);
    }
