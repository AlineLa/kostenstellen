...
public class KostenArtWurzelICProxi extends AbstrakteKostenArtICProxi implements PersistentKostenArtWurzel{
    
    public KostenArtWurzelICProxi(long objectId) {
        super(objectId);
    }
    public KostenArtWurzelICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theKostenArtWurzelFacade
            .getKostenArtWurzel(this.getId());
    }
