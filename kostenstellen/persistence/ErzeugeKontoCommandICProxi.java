...
public class ErzeugeKontoCommandICProxi extends PersistentInCacheProxi implements PersistentErzeugeKontoCommand{
    
    public ErzeugeKontoCommandICProxi(long objectId) {
        super(objectId);
    }
    public ErzeugeKontoCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theErzeugeKontoCommandFacade
            .getErzeugeKontoCommand(this.getId());
    }
