...
public class TransFacdeTransaktionsProxi extends PersistentProxi implements PersistentTransFacdeTransaktions{
    
    public TransFacdeTransaktionsProxi(long objectId) {
        super(objectId);
    }
    public TransFacdeTransaktionsProxi(PersistentInCacheProxi object) {
        super(object);
    }
