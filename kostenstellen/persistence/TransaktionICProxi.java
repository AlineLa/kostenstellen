...
public class TransaktionICProxi extends PersistentInCacheProxiOptimistic implements PersistentTransaktion{
    
    public TransaktionICProxi(long objectId) {
        super(objectId);
    }
    public TransaktionICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theTransaktionFacade
            .getTransaktion(this.getId());
    }
