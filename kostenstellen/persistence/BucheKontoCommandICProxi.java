...
public class BucheKontoCommandICProxi extends PersistentInCacheProxi implements PersistentBucheKontoCommand{
    
    public BucheKontoCommandICProxi(long objectId) {
        super(objectId);
    }
    public BucheKontoCommandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theBucheKontoCommandFacade
            .getBucheKontoCommand(this.getId());
    }
