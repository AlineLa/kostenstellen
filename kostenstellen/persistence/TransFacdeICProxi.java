...
public class TransFacdeICProxi extends PersistentInCacheProxiOptimistic implements PersistentTransFacde{
    
    public TransFacdeICProxi(long objectId) {
        super(objectId);
    }
    public TransFacdeICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theTransFacdeFacade
            .getTransFacde(this.getId());
    }
