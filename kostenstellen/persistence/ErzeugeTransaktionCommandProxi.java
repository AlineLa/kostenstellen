...
public class ErzeugeTransaktionCommandProxi extends PersistentProxi implements PersistentErzeugeTransaktionCommand{
    
    public ErzeugeTransaktionCommandProxi(long objectId) {
        super(objectId);
    }
    public ErzeugeTransaktionCommandProxi(PersistentInCacheProxi object) {
        super(object);
    }
