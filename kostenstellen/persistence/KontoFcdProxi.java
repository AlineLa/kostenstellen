...
public class KontoFcdProxi extends PersistentProxi implements PersistentKontoFcd{
    
    public KontoFcdProxi(long objectId) {
        super(objectId);
    }
    public KontoFcdProxi(PersistentInCacheProxi object) {
        super(object);
    }
