...
public class LohnKostenICProxi extends KonkreteKostenArtICProxi implements PersistentLohnKosten{
    
    public LohnKostenICProxi(long objectId) {
        super(objectId);
    }
    public LohnKostenICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theLohnKostenFacade
            .getLohnKosten(this.getId());
    }
