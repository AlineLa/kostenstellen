...
public abstract class KonkreteKostenArtProxi extends AbstrakteKostenArtProxi implements PersistentKonkreteKostenArt{
    
    public KonkreteKostenArtProxi(long objectId) {
        super(objectId);
    }
    public KonkreteKostenArtProxi(PersistentInCacheProxi object) {
        super(object);
    }
