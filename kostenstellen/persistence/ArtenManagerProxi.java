...
public class ArtenManagerProxi extends PersistentProxi implements PersistentArtenManager{
    
    public ArtenManagerProxi(long objectId) {
        super(objectId);
    }
    public ArtenManagerProxi(PersistentInCacheProxi object) {
        super(object);
    }
