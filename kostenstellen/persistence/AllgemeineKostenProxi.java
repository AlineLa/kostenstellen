...
public class AllgemeineKostenProxi extends KonkreteKostenArtProxi implements PersistentAllgemeineKosten{
    
    public AllgemeineKostenProxi(long objectId) {
        super(objectId);
    }
    public AllgemeineKostenProxi(PersistentInCacheProxi object) {
        super(object);
    }
