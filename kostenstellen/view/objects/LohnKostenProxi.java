...
public class LohnKostenProxi extends KonkreteKostenArtProxi implements LohnKostenView{
    
    public LohnKostenProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public LohnKostenView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ...
        LohnKostenView result$$ = new LohnKosten((AbstrakteKostenArtView)speziellerAls, this.getId(), this.getClassId());
