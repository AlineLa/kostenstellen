...
public class LohnKosten extends view.objects.KonkreteKostenArt implements LohnKostenView{
    
    
    public LohnKosten(AbstrakteKostenArtView speziellerAls,long id, long classId) {
