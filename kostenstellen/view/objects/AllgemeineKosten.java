...
public class AllgemeineKosten extends view.objects.KonkreteKostenArt implements AllgemeineKostenView{
    
    
    public AllgemeineKosten(AbstrakteKostenArtView speziellerAls,long id, long classId) {
