...
public class ReiseKostenProxi extends KonkreteKostenArtProxi implements ReiseKostenView{
    
    public ReiseKostenProxi(long objectId, long classId, ExceptionAndEventHandler connectionKey) {
        super(objectId, classId, connectionKey);
    }
    
    public ReiseKostenView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        ...
        ReiseKostenView result$$ = new ReiseKosten((AbstrakteKostenArtView)speziellerAls, this.getId(), this.getClassId());
